 ...
 * @author Mfsantos
 */
public class montarArquivo extends javax.swing.JFrame {

    Mensagens msg = new Mensagens();
    ValidaSair sair = new ValidaSair();
    IncluirDados incluir;

    public montarArquivo() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(montarArquivo.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Caminho das Imagens");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTFCaminho, javax.swing.GroupLayout.DEFAULT_SIZE, 776, Short.MAX_VALUE)
    ...
    private void Botao_GravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Botao_GravarActionPerformed
        if (jTFNomePlanilha.getText().equals("")) {
            msg.Mensagem_Visual(1, "Selecione a Planilha de Dados.");
            jTFNomePlanilha.grabFocus();
            return;
        }

        if (jTFCaminho.getText().equals("")) {
            msg.Mensagem_Visual(1, "Não carregou o caminho da Planilha.");
            jTFNomePlanilha.grabFocus();
            return;
        }
        ...
        try {
            jxls.leituraArquivo(jTFNomePlanilha.getText(), jTFCaminho.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new montarArquivo().setVisible(true);
            }
        });
    }
